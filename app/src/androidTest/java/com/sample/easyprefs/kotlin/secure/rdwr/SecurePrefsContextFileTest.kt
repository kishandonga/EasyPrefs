...
class SecurePrefsContextFileTest {
    ...
    fun test1_CommitOp() {
        Assert.assertTrue(
            Prefs.securely().write(context, SecureConst.SECURE_PREF_FILE)
