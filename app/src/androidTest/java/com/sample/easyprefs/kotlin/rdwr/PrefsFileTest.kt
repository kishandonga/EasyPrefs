...
class PrefsFileTest {
    ...
    fun testReadCommitOp() {
        ...
        val o2 = Prefs.read(Const.PREF_SAMPLE_FILE).content(Const.SAMPLE_INT_KEY, Int.MIN_VALUE)
        assertEquals(p2, o2)

        val o3 = Prefs.read(Const.PREF_SAMPLE_FILE).content(Const.SAMPLE_FLOAT_KEY, Float.MIN_VALUE)
        assertEquals(p3, o3)
        ...
        val o7 = Prefs.read(Const.PREF_SAMPLE_FILE).content(Const.SAMPLE_STRING_SET_KEY, setOf())
        assertEquals(p7, o7)
    }
